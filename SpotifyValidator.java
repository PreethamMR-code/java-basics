class SpotifyValidator {
    public static boolean validateSpotify(String name, String founder, int year, String hq, boolean podcasts, int users) {
        boolean nameOk = false;
        boolean founderOk = false;
        boolean yearOk = false;
        boolean hqOk = false;
        boolean podcastOk = true; // No validation needed for boolean
        ...
        return nameOk && founderOk && yearOk && hqOk && podcastOk && usersOk;
    }
}